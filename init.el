...
(defun dotspacemacs/user-config ()
  ...
  ;; align english and chinese. dreamslink
  ;; Auto generated by chinese-fonts-setup
  ;; <https://github.com/tumashu/chinese-fonts-setup>
  ;; (set-face-attribute
  ;;  'default nil
  ;;  :font (font-spec :name "-unknown-DejaVu Sans Mono-bold-oblique-normal-*-*-*-*-*-m-0-iso10646-1"
  ;;                   :weight 'normal
  ;;                   :slant 'normal
  ;;                   :size 11.5))
  ...
  ;;    charset
  ;;    (font-spec :name "文泉驿等宽微米黑-normal-normal-normal-*-*-*-*-*-*-0-iso10646-1"
  ;;               :weight 'normal
  ;;               :slant 'normal
  ;;               :size 13.5)))
  ...
  ;; (font-spec :family "SourceCodePro+Powerline+Awesome Regular" :size 12)))
